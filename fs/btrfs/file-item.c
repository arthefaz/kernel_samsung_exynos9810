...
static blk_status_t __btrfs_lookup_bio_sums(struct btrfs_root *root,
...
blk_status_t btrfs_lookup_bio_sums(struct btrfs_root *root, struct inode *inode,
			  struct bio *bio, u32 *dst)
{
	return __btrfs_lookup_bio_sums(root, inode, bio, 0, dst, 0);
}

blk_status_t btrfs_lookup_bio_sums_dio(struct btrfs_root *root, struct inode *inode,
...
blk_status_t btrfs_csum_one_bio(struct btrfs_root *root, struct inode *inode,

...
#include "uapi/gpu/arm/bv_r44p0/mali_kbase_mem_profile_debugfs_buf_size.h"
...
#include <uapi/gpu/arm/bv_r44p0/mali_kbase_ioctl.h>
#if !MALI_USE_CSF
...
#if IS_ENABLED(CONFIG_OF)
static const struct of_device_id kbase_dt_ids[] = { /* MALI_SEC_INTEGRATION */
						    { .compatible = "arm,mali", },
